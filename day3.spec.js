...
const getIntersectionsDistance = (list_1, list_2) => {
  const intersections = []
  for (let index_1 = 0; index_1 < list_1.length - 1; index_1++) {
    for (let index_2 = 0; index_2 < list_2.length - 1; index_2++) {
      // # 1. check if two lines are parallel or not
      // list 1
      const point_1_in_list_1 = list_1[index_1]
      const point_2_in_list_1 = list_1[index_1 + 1]
      // list 2
      const point_1_in_list_2 = list_2[index_2]
      const point_2_in_list_2 = list_2[index_2 + 1]
      if (
        (point_1_in_list_1.x === point_2_in_list_1.x && point_1_in_list_2.x === point_2_in_list_2.x)
        ||
        (point_1_in_list_1.y === point_2_in_list_1.y && point_1_in_list_2.y === point_2_in_list_2.y)
      ) {
          continue
      }
      // # 2. intersect
      if (
        ((point_1_in_list_1.y - point_1_in_list_2.y) * (point_2_in_list_1.y - point_2_in_list_2.y) < 0)
        &&
